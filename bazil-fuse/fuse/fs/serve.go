...
func (c *Server) serve(r fuse.Request) {
	...
	log.WithFields(log.Fields{"Op": opName(r), "Hdr": r.Hdr(), "Request": r}).Debug("Serve: ")
	...
	switch r := r.(type) {
	default:
		log.WithFields(log.Fields{"Request": r}).Info("Serve: Unknown request", r)
	...
	case *fuse.GetattrRequest:
		log.Debug("Serve: GetattrRequest")
	...
	case *fuse.SetattrRequest:
		log.Debug("Serve: SetattrRequest")
	...
	case *fuse.SymlinkRequest:
		log.Debug("Serve: SymlinkRequest")
	...
	case *fuse.ReadlinkRequest:
		log.Debug("Serve: ReadlinkRequest")
	...
	case *fuse.OpenRequest:
		...
		if n, ok := node.(NodeOpener); ok {
			...
			log.Debug("Serve: OpenRequest: NodeOpener DONT EXIST")
			h2 = node
		}
	...
	case *fuse.GetxattrRequest:
		log.Debug("Serve: GetxattrRequest")
	...
	case *fuse.ListxattrRequest:
		log.Debug("Serve: ListxattrRequest")
	...
	case *fuse.SetxattrRequest:
		log.Debug("Serve: SetxattrRequest")
	...
	case *fuse.RemovexattrRequest:
		log.Debug("Serve: RemovexattrRequest")
	...
	case *fuse.ReleaseRequest:
		log.Debug("Serve: ReleaseRequest")
		shandle := c.getHandle(r.Handle)
		if shandle == nil {
			done(fuse.ESTALE)
			r.RespondError(fuse.ESTALE)
	...
	case *fuse.DestroyRequest:
		log.Debug("Serve: DestroyRequest")
	...
	case *fuse.InterruptRequest:
		log.Debug("Serve: InterruptRequest")
		c.meta.Lock()
		ireq := c.req[r.IntrID]
